...
function AboutGrid4(props) {
    return (
        <div className="col-span-8 lg:col-span-2 row-span-2 px-6 py-8 flex flex-wrap font-medium [font-size:2.5rem] leading-[1.2] group content-start bg-about4 bg-right-bottom bg-no-repeat bg-contain">
