...
function AboutGrid6(props) {
    ...
    return (
        <Link href={'/contact'} className="col-span-8 lg:col-span-4 row-span-2 flex flex-wrap content-between py-8 px-6 font-medium [font-size:2.5rem] leading-[1.2] group bg-about1 bg-no-repeat bg-contain bg-left"
             onMouseEnter={() => {
                 setHover(true);
             }}
             onMouseLeave={() => {
